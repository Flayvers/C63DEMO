...
int main(void)
{
    ...
    while (!WindowShouldClose())
    {
        if (pacMan)
        {
            ...
            DrawCircleSector(pacmanPos, 90.0f, 35.0f, 325.0f, 1000.0f, YELLOW);
            DrawCircle(380, (screenHeight / 2.0f), 35.0f, LIGHTGRAY);
            DrawCircle(485, (screenHeight / 2.0f), 35.0f, LIGHTGRAY);
            DrawCircle(590, (screenHeight / 2.0f), 35.0f, LIGHTGRAY);
